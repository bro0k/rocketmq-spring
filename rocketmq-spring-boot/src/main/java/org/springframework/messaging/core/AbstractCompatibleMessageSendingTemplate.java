 ...
 */
public abstract class AbstractCompatibleMessageSendingTemplate<D> implements MessageSendingOperations<D> {
     ...
     */
    protected Message<?> doConvert(Object payload,  Map<String, Object> headers,
